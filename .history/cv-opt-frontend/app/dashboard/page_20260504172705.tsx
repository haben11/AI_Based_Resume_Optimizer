            ...
            <div className="space-y-10">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl transition-all text-sm font-bold ${
                      isRefining ? "bg-primary-500 text-white shadow-lg shadow-primary-500 shadow-opacity-25" : "bg-white bg-opacity-5 hover:bg-white bg-opacity-10 text-surface-200"
                    }`}
                  >
                   ...
                   <button
                    onClick={handleReset}
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white bg-opacity-5 hover:bg-white bg-opacity-10 text-surface-200 transition-colors text-sm font-medium"
                  >
              ...
              {isRefining ? (
                <motion.div 
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="relative glass rounded-[2.5rem] p-10 border border-white border-opacity-10 shadow-2xl"
                >
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <h3 className="text-xl font-bold text-white mb-1">AI-Powered Editor</h3>
                      <p className="text-surface-200 text-opacity-50 text-sm">Edit directly or highlight text to regenerate it with market-grounded AI.</p>
                    </div>
                       ...
                       <AnimatePresence>
                          {selection && (
                            <motion.button
                              ...
                              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-2xl font-bold text-sm shadow-xl shadow-primary-500 shadow-opacity-30 hover:scale-[1.02] active:scale-95 transition-all"
                            >
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full h-[650px] bg-black bg-opacity-40 border border-white border-opacity-5 rounded-[2rem] p-10 text-surface-50 font-mono text-sm focus:outline-none focus:border-primary-500 focus:border-opacity-30 transition-all resize-none shadow-inner leading-relaxed"
                      placeholder="Edit your resume here..."
                    />
                    <div className="absolute top-6 right-10 text-[10px] font-black text-white text-opacity-10 uppercase tracking-widest pointer-events-none">
                ...
                {templates.map((template) => {
                  ...
                  return (
                    <div key={template.id} className="group flex flex-col glass rounded-[2.5rem] overflow-hidden border border-white border-opacity-5 hover:border-primary-500 hover:border-opacity-30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary-500 shadow-opacity-10">
                      ...
                      <div className="relative bg-white overflow-hidden" style={{ aspectRatio: "3 / 4" }}>
                        ...
                        <div className="absolute inset-0 bg-primary-500 bg-opacity-80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center p-8">
                          <div className="text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                             <div className="w-16 h-16 rounded-full bg-white bg-opacity-20 flex items-center justify-center mx-auto mb-4 border border-white border-opacity-30">
                                <CheckCircle2 className="w-8 h-8 text-white" />
                             </div>
                             <p className="text-white font-black text-xl mb-2 uppercase tracking-tighter">Use this Template</p>
                             <p className="text-white text-opacity-70 text-xs px-4">Download your optimized resume instantly in this style.</p>
                          </div>
                        </div>
                        ...
                        <button 
                          ...
                          className="absolute bottom-6 left-1/2 -translate-x-1/2 px-6 py-2 bg-primary-500 text-white font-bold text-xs rounded-full opacity-0 group-hover:opacity-100 transition-all shadow-xl shadow-primary-500 shadow-opacity-40 z-20"
                        >
                          Use this template
                        </button>
                      </div>
                      ...
                      <div className="p-8 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <button
                            ...
                            disabled={isDownloading}
                            className="flex items-center justify-center gap-2 py-3 rounded-2xl bg-primary-600 hover:bg-primary-500 text-white text-xs font-bold transition-all shadow-lg shadow-primary-500 shadow-opacity-20 active:scale-95 disabled:opacity-50"
                          >
