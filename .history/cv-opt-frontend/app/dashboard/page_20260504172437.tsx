      ...
      <div className="p-4 space-y-3">
        {templateId === "tokyo-1" ? (
          <div className="space-y-4">
             <div className="h-1 w-full bg-primary-500/20" />
             <div className="space-y-1">
                <div className="h-4 w-2/3 bg-zinc-900 rounded-sm" />
                <div className="h-2 w-1/3 bg-primary-500/10 rounded-sm" />
             </div>
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-10">
        ...
        <p className="text-surface-200/50">Follow the steps below to tailor your resume for any job.</p>
      </div>
        ...
        {[
          ...
          <div key={s.num} className="flex items-center gap-3 shrink-0">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold border transition-colors ${
              step >= s.num ? "bg-primary-500 border-primary-500 text-white" : "border-white/10 text-surface-200/30"
            }`}>
              {step > s.num ? <CheckCircle2 className="w-5 h-5" /> : s.num}
            </div>
            <span className={`text-sm font-medium ${step >= s.num ? "text-surface-50" : "text-surface-200/30"}`}>
              {s.label}
            </span>
            {s.num < 3 && <div className="w-10 h-px bg-white/10 mx-2" />}
          </div>
        ))}
      </div>
        ...
        {step === 1 && (
          ...
          >
            <div {...getRootProps()} className={`upload-zone rounded-2xl p-16 cursor-pointer ${isDragActive ? "dragging" : ""}`}>
              ...
              <p className="text-surface-200/50 mb-8 max-w-sm mx-auto">
                Support PDF and DOCX files. Our AI will extract your skills and experience automatically.
              </p>
              {error && (
                <div className="flex items-center justify-center gap-2 text-danger-500 text-sm mb-6 bg-danger-500/10 p-3 rounded-lg border border-danger-500/20">
                  <AlertCircle className="w-4 h-4" />
                  {error}
                </div>
              )}
              <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 border border-white/10 rounded-xl font-medium hover:bg-white/10 transition-colors">
                Select File
              </div>
            </div>
          </motion.div>
            ...
            {!isStreaming ? (
              <>
                <textarea
                  ...
                  className="w-full h-80 bg-white/5 border border-white/10 rounded-2xl p-6 text-surface-50 placeholder:text-surface-200/20 focus:outline-none focus:border-primary-500/50 transition-all mb-8 resize-none"
                />
                
                {error && (
                  <div className="flex items-center gap-2 text-danger-500 text-sm mb-6 bg-danger-500/10 p-4 rounded-xl border border-danger-500/20">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-8 py-3.5 text-sm font-semibold text-white gradient-primary rounded-xl hover:opacity-90 transition-all shadow-lg shadow-primary-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="space-y-6">
                ...
                {tokens && (
                  <div className="space-y-3">
                    ...
                    <div className="h-64 bg-white/5 border border-white/10 rounded-2xl p-6 overflow-auto">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl transition-all text-sm font-bold ${
                      isRefining ? "bg-primary-500 text-white shadow-lg shadow-primary-500/25" : "bg-white/5 hover:bg-white/10 text-surface-200"
                    }`}
                  >
